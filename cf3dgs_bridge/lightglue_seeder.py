"""lightglue_seeder — stitched from cf3dgs_bridge/_lightglue_seeder_parts/part*.txt (MCP size limits)."""
from __future__ import annotations
from pathlib import Path
_PART_DIR = Path(__file__).resolve().parent / "_lightglue_seeder_parts"
